      ...
      <table className="min-w-full text-sm border-collapse">
        <thead>
          <tr className="text-xs text-gray-400 uppercase border-b border-gray-800 bg-gray-900/80">
            <th className="p-3 text-left w-[120px]">Event ID</th>
            <th className="p-3 text-left w-[120px]">Type</th>
            <th className="p-3 text-center w-[100px]">Player #</th>
            <th className="p-3 text-center w-[120px]">Confidence</th>
            <th className="p-3 text-center w-[150px]">Time</th>
            <th className="p-3 text-left w-[250px]">Notes</th>
          </tr>
        </thead>
        ...
        <tbody>
          {events.map((ev, i) => (
            <motion.tr
              ...
              className={`transition border-b border-gray-800/70 hover:bg-gray-800/40 ${
                i % 2 === 0 ? "bg-gray-900/40" : "bg-gray-950/30"
              }`}
            >
              <td className="p-3 text-gray-300 truncate">{ev.event_id}</td>
              ...
              <td
                className="p-3 text-gray-300 max-w-[250px] truncate"
                title={ev.notes ?? ""}
              >
                {ev.notes ?? "-"}
              </td>
